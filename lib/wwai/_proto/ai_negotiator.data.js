/* ═══════════════════════════════════════════════════════════════════
   Workwise · AI Negotiator prototype — demo dataset
   RFQ #535944 · Housekeeping Linen & Amenities — Q3 FY 2026-27
   Tenant: Workwise Hotels · BU: Workwise Grand, Mumbai · Housekeeping
...
window.WWData = (function () {
  ...
  var rfq = {
    ...
    status: 'PUBLISHED',
    company: 'Workwise Hotels',
    businessUnit: 'Workwise Grand, Mumbai',
    department: 'Housekeeping',
    contactPerson: 'Kushal Shah',
    contactNumber: '+91-8454008272',
    responseEmail: 'procurement@workwisehotels.in',
    submissionDeadline: '12 Aug 2026, 06:00 pm',
    deliveryLocation: 'Workwise Grand, Marine Drive — Linen Store, Mumbai 400020',
  ...
  var vendors = [
    ...
    {
      id: 'gokul',
      name: 'Gokul Hospitality Supplies',
      initials: 'GH',
      ...
      history: {
        ...
        floorSeen: 404,
        note: 'Billed ₹404 to Workwise Lake Paradise on PO-2026-04127 (May 2026)'
      },
      ai: {
        include: true,
        tone: 'yes',
        ...
        skip: [],
        why: 'Quoted ₹441 here but billed ₹404 to Workwise Lake Paradise eleven weeks ago for the same 500 GSM construction. Three of its looms are idle this quarter and its 25-day lead time says it is chasing volume, not schedule.',
        ask: 'Confront the ₹404 internal benchmark, ask ₹396, and give back 20 days of lead time to pay for it.'
      }
    },
    {
      id: 'meridian',
      name: 'Meridian Textile Co',
      initials: 'MT',
    ...
    },
    {
      ...
      ai: {
        ...
        ask: 'Leave it out of the round. Keep the quote on file as cover if Meridian regrets.'
      }
    }
  ];
  ...
  var market = {
    asOf: '12 Aug 2026',
    indexName: 'Workwise linen index · bath towel 500 GSM (west India)',
    indexUnit: 401,
    bestTwelveMonth: { unit: 392, ref: 'ARC-2026-27-0007', when: 'Feb 2026', vendor: 'Anand Linen Mills', qty: 3200 },
    yarnMove: -4.1,
  ...
  var strategy = {
    ...
    confidence: 84,
    summary:
      'Shree is L1 at ₹412 and is already at its floor; the recoverable money sits with Anand and Gokul, who are both quoting well above rates they have personally accepted in the last six months.',
    ...
    findings: [
      {
        tone: 'warn',
        text: '<strong>L1 is the wrong target.</strong> Shree Textiles has quoted below ₹408 exactly zero times in 8 rounds, and its last two rounds moved <span class="mono">0.4%</span> and <span class="mono">0.0%</span>. Every rupee you ask off its rate costs round time you could spend elsewhere.',
        cites: [
          { label: 'Shree Textiles — quote', target: '#v-shree' },
          { label: 'Base Price target', target: '#field-base' }
        ]
      },
      {
        tone: 'good',
        text: '<strong>Anand Linen Mills is the real headroom.</strong> It conceded <span class="mono">7.4%</span> on average across its last 4 rounds, replies in a median <span class="mono">18h</span>, and already supplied this exact towel at <span class="mono">₹392</span> on ARC-2026-27-0007. Two Erode lines are idle through Q3.',
        cites: [
          { label: 'Anand Linen Mills — quote', target: '#v-anand' },
          { label: 'Anand · freight card', target: '#v-anand-freight' }
        ]
      },
      {
        tone: 'good',
        text: '<strong>Gokul is quoting 9% above its own invoice.</strong> ₹441 here versus <span class="mono">₹404</span> billed to Workwise Lake Paradise on PO-2026-04127 in May, same 500 GSM construction. Its 25-day lead time says it wants volume, so lead time is your currency.',
        cites: [{ label: 'Gokul Hospitality — quote', target: '#v-gokul' }]
      },
      {
        tone: 'warn',
        text: '<strong>Meridian quotes delivered-to-site.</strong> Freight is already inside its ₹455 — demanding a freight line would double-count it and hand it a reason to re-price. The freight field is skipped for this vendor only.',
        cites: [{ label: 'Meridian · freight card', target: '#v-meridian-freight' }]
      },
      {
        tone: 'bad',
        text: '<strong>Suvarna Linens is a regret risk.</strong> It withdrew from 2 of its last 3 rounds once the ask went past 3%, and at ₹470 it is 14.1% above L1 with no path to award. Pushing it converts a 5-quote RFQ into a 4-quote RFQ.',
        cites: [{ label: 'Suvarna Linens — quote', target: '#v-suvarna' }]
      }
    ],
    ...
    fieldPlan: [
      ...
      {
        field: 'Freight',
        target: '1.5% global · full waiver from Shree and Anand',
        evidence: 'Shree waived freight on 3 of its last 5 POs. Anand will trade it for 30-day payment. Skipped for Meridian (delivered-to-site).'
      },
      {
        field: 'Packaging',
      ...
      },
      {
        ...
        evidence: 'Linen store needs stock by 12 Sep. Gokul gets 20 days as the concession that pays for ₹396; Meridian holds 14.'
      },
      {
        field: 'Payment terms',
        target: 'Offer 30 days from GRN (Anand asked 45)',
      ...
      },
      {
        ...
        evidence: 'Gokul and Anand did not attach one. Two 2025 linen claims were lost for want of a GSM certificate at GRN.'
      }
    ],

    giveToGet: [
      'Offer <strong>30-day payment</strong> instead of Anand\'s 45 to buy the <strong>freight waiver</strong> — costs ~1.1%, saves 3.5%.',
      'Offer a <strong>single 4,000 pc lot</strong> with one dispatch to Shree in exchange for packaging at 1.0% and freight at nil.',
      'Concede <strong>20 days lead time</strong> to Gokul (its quote said 25) as the price of ₹396.',
      'Leave Meridian\'s <strong>25% advance</strong> untouched — it is the only certified supplier and the advance is what buys the 15-day lead time.'
    ],
