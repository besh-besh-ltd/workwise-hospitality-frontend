/* ═══════════════════════════════════════════════════════════════════
   Workwise · AI vendor matching — demo dataset + scoring model
   ───────────────────────────────────────────────────────────────────
   Tenant : Workwise Hotels
   BU     : Workwise Grand, Mumbai
   User   : Kushal Shah  ·  14 Aug 2026, IST
...
(function (global) {
  ...
  var VENDORS = [
    V({
      id: 'shree', name: 'Shree Textiles Pvt Ltd', city: 'Bhiwandi, MH',
    ...
    V({
      id: 'anand', name: 'Anand Linen Mills', city: 'Solapur, MH',
    ...
    V({
      ...
      rationale: 'Second-cheapest observed rate at ₹396 and a clean delivery record — 92% on time across five awards, no disputes. Priced within 1% of Shree without the approved-vendor status.'
    }),
    V({
    ...
    V({
      id: 'gokul', name: 'Gokul Hospitality Supplies', city: 'Vasai, MH',
    ...
    V({
      id: 'meridian', name: 'Meridian Textile Co', city: 'Surat, GJ',
    ...
    V({
      id: 'suvarna', name: 'Suvarna Linens', city: 'Ichalkaranji, MH',
  ...
  var ENGINEERING_NEAR_MISS = [
    {
      ...
      missing: 'no Workwise Grand hotel subscription — mapped to Lake Paradise only',
      history: '8 RFQs at Lake Paradise · 75% response · 2 awards'
    },
    {
      name: 'Deccan Mills Pvt Ltd',
      city: 'Ahmedabad, GJ',
      holds: 'Workwise Grand hotel subscription, valid to 31 Mar 2027',
      missing: 'subscription covers HOUSEKEEPING SUPPLY only, not ENGINEERING',
      history: '20 RFQs at Workwise Grand · 80% response · 3 awards'
    }
  ];
  ...
  var POOL = [
    ...
    P({ id: 'bath-towel-550-arc', kw: ['terry','guest','housekeeping'], name: 'BATH TOWEL 550 GSM', category: 'HOUSEKEEPING SUPPLY', sub: 'TOWEL', qty: 600, uom: 'PCS',
        ...
        arc: {
          ...
          scope: 'All Workwise Hotels properties'
        } }),
  ...
  var BASELINE = {
    typicalInvited: 6,
    medianQuotes: 4,
    note: 'median over the last 6 comparable towel RFQs at Workwise Grand',
  ...
  var FORECAST = {
    ...
    yarnIndexMove: -1.2,     // % since Shree's last award
    volumeBreakAt: 1000
  };
