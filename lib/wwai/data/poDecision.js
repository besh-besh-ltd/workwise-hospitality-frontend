...
(function (global) {
  ...
  var DETAIL = {
    ...
    '108250': {
      ...
      docs: [
        ...
        { name: 'Trident_TDS_ExhaustHood.pdf', sub: 'technical data sheet' },
    ...
    '108244': {
      ...
      rfq: '536425',
      rfqTitle: 'Mattress replacement — voco Jim Corbett, Udaipur · Phase 2',
      bu: 'voco Jim Corbett, Udaipur',
      dept: 'Housekeeping',
      bidders: 3,
      finalizedBy: 'Devika Rao',
      ...
      docs: [
        ...
        { name: 'NandanLinen_TDS_Mattress8IN.pdf', sub: 'technical data sheet' },
    ...
    '108258': {
      ...
      docs: [
        ...
        { name: 'Aarvi_TDS_ChillerAMC.pdf', sub: 'technical data sheet' },
  ...
  var VERDICTS = {
    ...
    '108231': {
      steps: [
        { label: 'Reading PO #108231 line items', note: '2 lines · 1,600 units · ₹12,36,480.00', ms: 620 },
    ...
    '108215': {
      steps: [
        { label: 'Reading PO #108215 line items', note: '1 line · 900 sets · ₹3,18,528.00', ms: 560 },
      ...
      result: {
        ...
        findings: [
          ...
          {
            tone: 'good',
            text: 'L1 on a 3-bidder round, ' + m('₹12,096.00') + ' under Nandan Terry Ltd and ' +
                  m('₹27,216.00') + ' under Welspun. The 9-day delivery is the middle of the three and fits the 22 Aug handover.',
            cites: [{ label: 'Quote comparison', target: '#compareCard' }]
          }
        ],
        ...
        processFindings: [
          ...
          {
            tone: 'good',
            text: 'Budget line ' + m('HK-LIN-2627') + ' (voco Jim Corbett) has ' + b('₹17.20L uncommitted') +
    ...
    '108250': {
      steps: [
        { label: 'Reading PO #108250 line items', note: '2 lines · 6 units · ₹8,69,660.00', ms: 580 },
        { label: 'Matching against 11 prior kitchen-ventilation orders', note: '18 months · 3 vendors', ms: 740 },
        { label: 'Parsing Trident_TDS_ExhaustHood.pdf against clauses TC-01 and TC-02', note: 'grade, size, airflow', ms: 720 },
      ...
      result: {
        ...
        findings: [
          ...
          },
          {
            ...
            text: 'L1 on a 3-bidder round, ' + m('₹33,180.00') + ' under Aarvi and ' + m('₹74,640.00') +
                  ' under GreenLeaf. The 35-day lead time is the longest of the three but still lands before the 20 Sep banquet reopening.',
            cites: [{ label: 'Quote comparison', target: '#compareCard' }]
          },
          {
            tone: 'good',
        ...
        techFindings: [
          {
            ...
            cites: [
              { label: 'Technical evaluation', target: '#techCard' },
              { label: 'Trident_QAP_Kitchen_2026.pdf', target: '#docsCard' }
            ]
          },
          {
            tone: 'good',
            ...
            cites: [{ label: 'Trident_TDS_ExhaustHood.pdf', target: '#docsCard' }]
          },
          {
            tone: 'good',
        ...
        processFindings: [
          {
            tone: 'good',
            text: 'Approval chain ' + b('L1→L2 matches policy PROC-04') + ' for the ₹5L–₹10L band. L1 Vipin Khandelwal signed within the delegation.',
            cites: [{ label: 'Audit trail', target: '#auditCard' }]
          },
          {
            tone: 'good',
    ...
    '108244': {
      steps: [
        { label: 'Reading PO #108244 line items', note: '1 line · 180 pcs · ₹5,96,736.00', ms: 540 },
        ...
        { label: 'Parsing NandanLinen_TDS_Mattress8IN.pdf against clause TC-01', note: 'gauge, spring count, foam', ms: 640 },
      ...
      result: {
        ...
        techFindings: [
          {
            ...
            cites: [
              { label: 'Technical evaluation', target: '#techCard' },
              { label: 'NandanLinen_TDS_Mattress8IN.pdf', target: '#docsCard' }
            ]
          },
          {
            tone: 'good',
        ...
        processFindings: [
          ...
          {
            tone: 'good',
            text: 'Budget line ' + m('HK-CAP-2627') + ' (voco Jim Corbett) has ' + b('₹31.10L uncommitted') + ' against ₹5,96,736.00 required.',
            cites: [{ label: 'RFQ context', target: '#rfqCard' }]
          },
          {
            tone: 'good',
    ...
    '108258': {
      steps: [
        { label: 'Reading PO #108258 line items', note: '2 lines · ₹27,81,968.00', ms: 640 },
        ...
        { label: 'Parsing Aarvi_TDS_ChillerAMC.pdf and QAP against clause TC-03', note: 'mandatory · OEM spares', ms: 820 },
      ...
      result: {
        ...
        findings: [
          ...
          {
            tone: 'bad',
            text: b('The award went to the higher of two bids.') + ' Trident Hometex Ltd quoted ' +
                  m('₹24,90,640.00') + ' against Aarvi at ' + m('₹27,81,968.00') +
        ...
        vendorFindings: [
          ...
          },
          {
            ...
            cites: [{ label: 'Aarvi_ISO45001.pdf', target: '#docsCard' }]
          },
          {
            tone: 'good',
            text: 'GSTIN ' + m('27AACFA9012P1ZR') + ' is active and GSTR-3B is filed through Jul 2026. Nothing here blocks input credit.',
            cites: [{ label: 'Vendor profile', target: '#vendorCard' }]
          }
        ],
        techFindings: [
          {
            ...
            cites: [
              { label: 'Technical evaluation', target: '#techCard' },
              { label: 'Aarvi_TDS_ChillerAMC.pdf', target: '#docsCard' }
            ]
          },
          {
            tone: 'bad',
            text: 'Overall technical score is ' + b('58% against a 70% pass mark') +
                  ' — marked Failed by Vipin Khandelwal on 10 Aug 2026. The PO was raised two days later against a bid that did not qualify.',
            cites: [
              { label: 'Technical evaluation', target: '#techCard' },
        ...
        processFindings: [
          ...
          {
            tone: 'warn',
            text: b('Possible duplicate.') + ' PO #108177 (28 Jul 2026) to Trident Hometex Ltd covers the same 450 TR AMC scope for the same asset and is still open at L2. If both conclude you pay twice for one contract year.',
            cites: [{ label: 'Audit trail', target: '#auditCard' }]
          }
        ],
        change: 'Re-award at the ARC-2026-0041 rate of ₹18,82,000.00 with OEM spares confirmed in writing and a 4-hour response window, or run a fresh single-vendor negotiation against Trident’s ₹24,90,640.00. Either route still needs the L4 step added and PO #108177 withdrawn first.',
  ...
  var QUEUE = {
    ...
    triage: [
      ...
      { po: '108215', verdict: 'yes',       vendor: 'Sriram Textiles Pvt Ltd',         line: 'best rate in 24 months, spec matches TC-01 exactly', amount: 318528 },
      { po: '108231', verdict: 'attention', vendor: 'Welspun Hospitality Solutions', line: 'ISO 9001 expired 47 days ago; GSM tolerance wider than TC-02', amount: 1236480 },
      { po: '108250', verdict: 'attention', vendor: 'Trident Hometex Ltd',  line: 'fire-damper test certificate missing from the QAP pack', amount: 869660 },
      { po: '108258', verdict: 'no',        vendor: 'Aarvi Linens & Amenities',     line: '19.0% above the ARC rate, mandatory clause TC-03 failed', amount: 2781968 }
    ],
    result: {
      verdict: 'attention',
      ...
      findings: [
        {
          tone: 'good',
          text: b('2 POs clear on every check') + ' — #108244 and #108215, ' + m('₹9,15,264.00') +
        ...
        {
          tone: 'warn',
          text: b('2 POs need one document each') + ' — #108231 (ISO 9001 lapsed 28 Jun 2026) and #108250 (fire-damper test report missing), holding ' +
                m('₹21,06,140.00') + '. Neither has a pricing problem.',
          cites: [{ label: 'Awaiting your approval', target: '#awaiting' }]
        },
        {
          tone: 'bad',
          text: b('1 hard no') + ' — #108258, ' + m('₹27,81,968.00') +
      ...
      compare: [
        ...
        { k: 'Should not proceed', v: '₹27.82L', n: '1 PO · #108258', tone: 'up' },
