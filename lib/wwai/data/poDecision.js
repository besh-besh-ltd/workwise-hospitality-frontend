...
(function (global) {
  ...
  /* ── people ─────────────────────────────────────────────────────── */
  var PEOPLE = {
    kushal:  { name: 'Dhruv Menon',  ini: 'KS', av: 'avGreen__pymZt' },
    ritika:  { name: 'Priya Nair', ini: 'RM', av: 'avRose__QmMGS' },
    vikram:  { name: 'Vikram Sethi',  ini: 'VN', av: 'avSky__QkqM5' },
    devika:  { name: 'Devika Rao',   ini: 'DR', av: 'avIndigo__pYPbr' },
    meera:   { name: 'Ananya Rao',   ini: 'MI', av: 'avZinc___YLe7' }
  };
  ...
  var ROWS = [
    ...
    },
    {
      ...
      pendingLine: 'on L2 — Dhruv Menon, Ananya Rao',
    ...
    },
    {
      ...
      pendingLine: 'on L3 — Dhruv Menon, Ananya Rao',
  ...
  var DETAIL = {
    ...
    '108231': {
      ...
      dept: 'Housekeeping',
      bidders: 3,
      finalizedBy: 'Dhruv Menon',
      pendingNote: 'Pending approval — currently with L3: Dhruv Menon (you).',
      asideNote: 'Currently with L3: Dhruv Menon. Two approvers can act — any one is enough.',
      pdf: 'PO 108231.pdf',
      total: 1236480,
      items: [
        {
      ...
      techEval: [
        {
          ...
          approver: 'Priya Nair', when: '10 Aug 2026 · 04:12 PM',
          clauses: [
    ...
    '108215': {
      ...
      dept: 'Housekeeping',
      bidders: 3,
      finalizedBy: 'Priya Nair',
      pendingNote: 'Pending approval — currently with L2: Dhruv Menon (you).',
      asideNote: 'Currently with L2: Dhruv Menon. You are the only approver on this step.',
      pdf: 'PO 108215.pdf',
      total: 318528,
      items: [
        {
      ...
      techEval: [
        {
          ...
          approver: 'Priya Nair', when: '06 Aug 2026 · 11:20 AM',
          clauses: [
    ...
    '108250': {
      ...
      pendingNote: 'Pending approval — currently with L2: Dhruv Menon (you).',
      asideNote: 'Currently with L2: Dhruv Menon. Two approvers can act — any one is enough.',
      pdf: 'PO 108250.pdf',
      total: 869660,
      items: [
        {
      ...
      techEval: [
        {
          ...
          approver: 'Vikram Sethi', when: '12 Aug 2026 · 11:05 AM',
          clauses: [
      ...
      techEval: [
        {
          ...
          approver: 'Priya Nair', when: '10 Aug 2026 · 03:30 PM',
          clauses: [
    ...
    '108258': {
      ...
      finalizedBy: 'Devika Rao',
      pendingNote: 'Pending approval — currently with L3: Dhruv Menon (you).',
      asideNote: 'Currently with L3: Dhruv Menon. Policy PROC-04 also requires an L4 step above ₹25L.',
      pdf: 'PO 108258.pdf',
      total: 2781968,
      items: [
        {
      ...
      techEval: [
        {
          ...
          approver: 'Vikram Sethi', when: '10 Aug 2026 · 06:05 PM',
          clauses: [
    ...
    '108231': {
      ...
      result: {
        ...
        processFindings: [
          {
            tone: 'good',
            text: 'Approval chain ' + b('L1→L3 matches policy PROC-04') + ' for the ₹10L–₹15L band. L1 Vikram Sethi and L2 Priya Nair both hold live delegations; you are a valid L3.',
    ...
    '108250': {
      ...
      result: {
        ...
        processFindings: [
          {
            tone: 'good',
            text: 'Approval chain ' + b('L1→L2 matches policy PROC-04') + ' for the ₹5L–₹10L band. L1 Vikram Sethi signed within the delegation.',
            cites: [{ label: 'Audit trail', target: '#auditCard' }]
          },
          {
            tone: 'good',
        ...
        techFindings: [
          ...
          },
          {
            ...
            text: 'Overall technical score is ' + b('58% against a 70% pass mark') +
                  ' — marked Failed by Vikram Sethi on 10 Aug 2026. The PO was raised two days later against a bid that did not qualify.',
            cites: [
              { label: 'Technical evaluation', target: '#techCard' },
