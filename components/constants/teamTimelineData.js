export const teamTimelineData = {
  hero: {
    title: "Meet the Team Behind Workwise",
  ...
  missionSection: {
    title: "Want to Join the Mission?",
    description: "We're always looking for sharp, mission-driven folks across AI, sales, procurement, and product.",
