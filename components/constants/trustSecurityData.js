export const trustSecurityData = {
  hero: {
  ...
  faqs: [
    {
      ...
      answer: "All data is hosted on the AWS India region with automatic daily backups and a 99.9% uptime SLA."
    },
    {
      question: "Can we restrict access by project or team?",
      answer: "Yes. Granular role-based access controls let you set project-specific and team-specific permissions."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. Workwise keeps a full version history with timestamps for every quote submission and modification."
    }
  ]
}; 