...
export const ourStoryData = {
  ...
  // Mission Section
  mission: {
    title: "Our Mission: Two-Sided Empowerment",
    leftColumn: {
      title: "Empowering Buyers & Contractors",
      benefits: [
        "Save up to 10% on procurement costs",
        "Free up 90% of procurement time",
        "Focus on strategic execution"
      ]
    },
    rightColumn: {
      title: "Empowering Vendors & Sellers",
      benefits: [
        "Grow business by 20%+",
        "Expand reach beyond known circles",
        "Get relevant, real-time order flow"
      ]
    }
  },
  ...
  whatWeBuilt: {
    ...
    description: "Our AI-powered tools are built by our talented team of IIT and VIT graduates, combining technical excellence with deep industry knowledge."
  },
