              ...
              <div className="quote-sec-table quote-sec-tab">
                ...
                {!isContentLoading && !isAccessDenied && <div className="quote-sec-main">
                  <>
                    ...
                    {/* AI Technical Evaluator — the same signed-off panel the
                        rate-contract stage carries, on the RFQ evaluation. Only
                        shown once clauses exist: with nothing configured there
                        is no evidence for it to read. */}
                    {clauseInfo && clauseInfo.length > 0 && (
                      <WwAiPanel
                        id="ai-tech-eval"
