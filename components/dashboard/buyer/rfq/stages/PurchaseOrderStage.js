...
export default function PurchaseOrderStage({ rfq, stage }) {
  ...
  // The model's purchase_order phase may carry a PO list under common keys.
    ...
    <section className="section-card">
      <div className="section-head">
        <div className="h-left">
          <div><h2>Purchase orders</h2><div className="h-sub">POs raised from this RFQ. The PO module is the system-of-record.</div></div>
        </div>
