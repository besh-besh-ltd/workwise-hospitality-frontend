...
import DemoActionButton from "@/components/ihg/DemoActionButton";
            ...
            <div style={{ display: "flex", gap: 6 }} onClick={(e) => e.stopPropagation()}>
              {isDraft ? (
                ...
                <>
                  ...
                  {/* Demo only: no vendor side exists, so this stands in for
                      the suppliers answering. Disappears once they have. */}
                  {row.demo_awaiting_publish && <DemoActionButton rfqId={row.rfq_no} variant="publish" />}
                  {row.demo_awaiting_close && <DemoActionButton rfqId={row.rfq_no} variant="closeBidding" />}
