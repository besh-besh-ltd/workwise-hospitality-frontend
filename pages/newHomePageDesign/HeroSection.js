...
export default function HeroSection() {
  ...
  return (
    <div className="mt-5" style={{ height: "95vh", background: "linear-gradient(50deg, #005F96, #50A055)" }}>
      ...
      <div className={`d-flex flex-lg-row flex-column justify-content-lg-around justify-content-center align-items-center`} style={{
          padding: "40px 20px",
          textAlign: "center",
          color: "white",
        ...
        <div className="text-center text-lg-start">
          <h1 className="fw-bold fs-1 mb-4 text-white">Procurement se profit banao</h1>
          <p className="mb-0 fw-semibold fs-6 text-warning">Is your procurement causing</p>
