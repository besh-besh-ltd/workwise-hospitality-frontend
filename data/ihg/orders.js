...
export const purchaseOrders = [
  ...
  // ── the rest of the approver's queue ──
  {
    id: "108231",
    ref: "PO #108231",
    title: "Bath linen replenishment — Rooms & Spa",
    ...
    status: "Pending approval",
    lines: [
      { itemId: "twl-bath-500", name: "Bath Towel 500 GSM", qty: 1200, rate: 850, value: 1020000, vsLastAwardPct: 6.3 },
      { itemId: "bath-mat", name: "Bath Mat 900 GSM", qty: 400, rate: 210, value: 84000, vsLastAwardPct: 0 },
    ],
    value: 1104000,
    budget: { head: "Housekeeping — linen & amenities, FY 2026-27", allocated: 8600000, consumed: 6900000 },
    riskNote: "Rate is 6.3% above the last award and the supplier's ISO 9001 certificate lapsed on 28 Jun 2026.",
    chain: [
  ...
  },
  {
    ...
    status: "Pending approval",
    lines: [
      { itemId: "bed-sheet-300", name: "Bed Sheet 300 TC", qty: 800, rate: 1059, value: 847200, vsLastAwardPct: 5.1 },
      { itemId: "duvet-cover", name: "Duvet Cover 300 TC", qty: 240, rate: 1386, value: 332640, vsLastAwardPct: 0 },
    ],
    value: 1179840,
    budget: { head: "Housekeeping — linen & amenities, FY 2026-27", allocated: 21500000, consumed: 9800000 },
    chain: [
